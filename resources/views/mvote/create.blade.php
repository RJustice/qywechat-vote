...
<div class="container">
    <div class="row" style="margin-bottom:20px;">
        <div class="col-md-10 col-md-offset-1">
            <form action="{{ url('manage/vote/store') }}" method="post" id="voteForm">
                <div class="form-group">
                    <label for="title"></label><input type="text" class="form-control" placeholder="输入调研标题" id="title" name="title">
                </div>
                <div class="form-group">
                    <label for="info"></label>
                    <textarea class="form-control" placeholder="输入调研的说明" name="info" id="info"></textarea>
                </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div id="questions">
                            <div class="form-group question">
                                <div class="row">
                                    <div class="col-md-8">
                                        <input type="text" name="q[]" id="" class="form-control" placeholder="输入调研选项">
                                    </div>
                                    <div class="col-md-2 text-center">
                                        <input type="text" name="p[]" id="" class="form-control percent" placeholder="百分比">
                                    </div>
                                    <div class="col-md-2 text-center">
